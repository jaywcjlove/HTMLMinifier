...
- `removeAttributeQuotes`: Remove unnecessary attribute quotes
...
- `removeScriptTypeAttributes`: Remove type attributes from script tags
- `removeStyleLinkTypeAttributes`: Remove type attributes from style and link tags
...
- `minifyJS`: Minify inline JavaScript
